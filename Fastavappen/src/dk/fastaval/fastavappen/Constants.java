...
public class Constants {
	...
	public static final String MESSENGER_EXTRA = "Messenger extra";
	public static final String JOB_EXTRA = "Job extra";
	
	public static final String TYPE_ROLE = "rolle";
	public static final String TYPE_BOARD = "braet";

...
public class ProgramIntentService extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		if (extras != null) {
			...
			SharedPreferences preferences = getSharedPreferences(Constants.FASTA_PREFERENCES, Context.MODE_PRIVATE);

			try {
				msg.obj = PH.getProgramData(preferences.getString(Constants.FASTA_PROGRAM_EXCLUDE, ""));
